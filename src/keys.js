...
const PLANS = {
  free: { name: 'Free', callsPerDay: 20, ratePerMinute: 5 },
  starter: { name: 'Starter', callsPerDay: 500, ratePerMinute: 30, price: '$9.99/mo' },
  pro: { name: 'Pro', callsPerDay: 5000, ratePerMinute: 100, price: '$29.99/mo' },
};
...
const createKey = (plan = 'pro', email = null, stripeCustomerId = null) => {
  const keys = loadKeys();
  const apiKey = `hl7_${randomUUID().replace(/-/g, '')}`;
